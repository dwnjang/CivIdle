export const KR = {
   About: "CivIdle에 대하여",
   AbuSimbel: "아부 심벨",
   AbuSimbelDesc: "람세스 2세의 효과가 두배가 됩니다. 모든 인접한 불가사의가 행복도 +1을 얻습니다.",
   ...
   AccountUpgradeConfirmDescV2:
      "계정을 업드레이드하면 <b>현재 게임이 리셋되며</b> 가능한 레벨 내의 영구 위인이 다음 게임으로 이월됩니다. 이 행동은 <b>되돌릴 수 없습니다,</b>, 진행하시겠습니까?",
   Acropolis: "아크로폴리스",
   ActorsGuild: "배우 길드",
   ...
   ApplyToBuildingsToastHTML: "<b>%{count} %{building}</b>에 적용되었습니다.",
   Aqueduct: "수로",
   ...
   Artillery: "야포",
   ArtilleryFactory: "야포 공장",
   Ashurbanipal: "아슈르바니팔",
   Assembly: "조립",
   Astronomy: "천문학",
   Athens: "아테네",
   AtomicBomb: "핵폭탄",
   AtomicFacility: "핵폭탄 공장",
   AtomicTheory: "핵 이론",
   Autocracy: "독재",
   Aviation: "항공학",
   BackToCity: "도시로 돌아가기",
   ...
   BrandenburgGateDesc:
      "모든 석탄광산과 유정이 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다. 정유 공장이 인접한 석유 타일 하나당 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다.",
   Bread: "빵",
   Brewery: "양조장",
   Brick: "벽돌",
   Brickworks: "벽돌 공장",
   ...
   BuildingDefaults: "건물 기본 설정",
   BuildingDefaultsCount: "%{count} 개의 건물이 기본 설정으로 변경되었습니다",
   BuildingDefaultsRemove: "모든 기본 설정을 원래대로 돌림",
   BuildingMultipliers: "가속",
   BuildingName: "이름",
   BuildingNoMultiplier:
      "%{building}은 생산, 저장소, 작업자등 용량 배수에 <b>영향을 받지 않습니다.</b>",
   ...
   ChooseGreatPersonChoicesLeft: "%{count}명의 위인이 남았습니다",
   Church: "교회",
   CircusMaximus: "키르쿠스 막시무스",
   CircusMaximusDescV2:
      "+5 행복도. 음악가 길드, 작가 길드, 화가 길드가 +1 생산, 저장소 용량 배수를 얻습니다.",
   CityState: "도시 국가",
   CityViewMap: "도시",
   CivIdle: "CivIdle",
   ...
   Colonialism: "식민주의",
   Colosseum: "콜로세움",
   ColosseumDesc: "전차공장은 행복도 -1이 면제 되며, 전차 10을 소모하여 행복 10을 생산합니다.",
   ...
   ConfirmYes: "예",
   Confucius: "공자",
   ConfuciusDesc: "작업 중인 작업자가 50% 이상일 경우 작업자 과학 생산 +%{value}",
   Conglomerate: "복합기업",
   Constitution: "헌법",
   Construction: "건축",
   ...
   ElectrificationStatus: "전력 현재상태",
   ElectrificationStatusActive: "활성화",
   ElectrificationStatusNoPower: "전력 없음",
   ElectrificationStatusNotActive: "활성화되지 않음",
   ElectrificationUpgrade: "전력화 해금. 건물이 전력을 소모하여 생산을 늘릴수 있습니다.",
   Electrolysis: "전기 분해",
   Embassy: "대사관",
   EmpireValueFromBuildings: "자원으로 인한",
   EmpireValueFromResources: "건물으로 인한",
   ...
   Exploration: "탐험",
   Explorer: "탐험가",
   ExploreThisTile: "탐험가 보내기",
   ExploreThisTileHTML:
      "탐험가는 <b>이 타일과 인접 타일</b>을 탐험합니다. 탐험가는 %{name}에서 생산됩니다. %{count} 탐험가가 있습니다",
   ExtraGreatPeople: "%{count} 추가 위인",
   ...
   Fibonacci: "피보나치",
   FibonacciDescV2:
      "+%{idle} 잉여 작업자 과학 생산. +%{busy} 노동중인 작업자 과학 생산. 피보나치의 영구 위인 업그레이드 비용은 피보나치 수열을 따릅니다.",
   Fire: "불",
   Firearm: "화기",
   ...
   ForbiddenCity: "자금성",
   ForbiddenCityDesc: "모든 제지소, 인쇄소, 작가 길드가 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다",
   Frigate: "프리깃",
   FrigateBuilder: "프리깃 조선소",
   Furniture: "가구",
   FurnitureWorkshop: "가구 공장",
   GalileoGalilei: "갈릴레오 갈릴레이",
   GalileoGalileiDesc: "+%{value} 잉여 작업자 과학 생산",
   Galleon: "갤리온",
   ...
   GreatMosqueOfSamarraDescV2:
      "+1 건물 시야. 5개의 랜덤 미탐험된 자원 타일을 밝히고, 거기에 10 레벨 자원 생산 건물을 만듭니다.",
   GreatPeople: "위인",
   ...
   GunpowderMill: "화약 공장",
   HagiaSophia: "하기아 소피아",
   HagiaSophiaDesc: "생산 용량이 0%인 건물은 행복도 -1이 면제됩니다. 신앙 10을 소비하여 행복도 10을 생산합니다.",
   Hammurabi: "함무라비",
   ...
   Hollywood: "헐리우드",
   HollywoodDesc: "+5 행복도. 2칸 안의 모든 문화를 사용하거나 생산하는 건물이 재고가 풍부하다면 +1 행복도를 얻습니다.",
   HolyEmpire: "신성 제국",
   Horse: "말",
   HorsebackRiding: "승마",
   House: "집",
   ...
   IronTech: "철",
   IsaacNewton: "아이작 뉴턴",
   IsaacNewtonDesc: "작업 중인 작업자가 50% 이상일 경우 작업자 과학 생산 +%{value}",
   IsambardKingdomBrunel: "이점바드 킹덤 브루넬",
   IsidoreOfMiletus: "이시도르의 밀레투스",
   ...
   MogaoCaves: "막고굴",
   MogaoCavesDescV2:
      "작업 중인 작업자 10% 당 +1 행복도를 얻습니다. 인접한 신당은 행복도 -1이 면제됩니다.",
   Mosque: "모스크",
   MotionPicture: "영화",
   MountSinai: "시나이 산",
   MountSinaiDesc:
      "발견시, 현재 시대의 위인이 탄생합니다. 모든 신앙을 생산하는 건물은 +5 저장소 배수를 얻습니다.",
   Movie: "영화",
   MovieStudio: "영화 스튜디오",
   Museum: "박물관",
   Music: "음악",
   ...
   Newspaper: "신문",
   NextExplorersIn: "탐험가 추가까지",
   NextMarketUpdateIn: "시장 갱신까지",
   NileRiver: "나일 강",
   NileRiverDesc:
      "하트셉수트의 효과가 두배가 됩니다. 모든 밀농장이 +1 생산, 저장소 배수를 얻습니다. 인접한 모든 밀농장이 +5 생산, 저장소 배수를 얻습니다.",
   NoDepositDesc:
   ...
   Optics: "광학",
   OptionsMenu: "설정",
   OptionsUseModernUIV2: "안티앨리어싱된 글꼴 사용",
   OxfordUniversity: "옥스포드 대학",
   OxfordUniversityDescV2: "건물 업그레이드 하나당 +5 과학을 얻습니다",
   PaintersGuild: "화가 길드",
   Painting: "그림",
   Pantheon: "판테온",
   PantheonDesc: "판테온",
   ...
   PermanentGreatPeopleAcquired: "획득한 영구적인 위인",
   ...
   ProductionPriorityDescV2:
      "우선순위가 높으면 다른 건물보다 먼저 자원이 운송됩니다. 숫자가 높을수록 우선순위가 높습니다.",
   Progress: "진행도",
   ...
   RequiredWorkersTooltip:
      "필요 작업자는 생산 배수의 결과 최종적으로 필요한 모든 자원의 합으로 결정됩니다. (전력화로 얻는 배수 제외)",
   RequirePower: "전기 필요",
   RequirePowerDesc:
      "이 건물은 전기가 있는 타일에만 지을 수 있으며, 전기를 옆 타일에 공급합니다.",
   Research: "연구",
   ResearchLab: "연구소",
   ResearchMenu: "연구",
   ResourceAmount: "양",
   ...
   ResourceTransportPreference: "운송 우선순위",
   ...
   RijksmuseumDesc:
      "행복도 +5, 문화를 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다.",
   RoadAndWheel: "도로와 바퀴",
   Robotics: "로봇공학",
   Rocket: "로켓",
   RocketFactory: "로켓 공장",
   ...
   SummerPalace: "이화원",
   SummerPalaceDesc:
      "화약을 생산하거나 소비하는 모든 인접한 건물은 행복도 -1이 면제되며, 화약을 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다.",
   Sword: "검",
   SwordForge: "검 대장간",
   ...
   TajMahal: "타지마할",
   TajMahalDescV2:
      "A great person of Classical Age and a great person of Middle Age are born. +5 건축가 용량 배수 when upgrading buildings over Level 20",
   TangOfShang: "탕왕",
   ...
   TechProductionPriority: "건물 우선순위 잠금 해제 - 건물별로 생산 우선순위 설정을 할 수 있습니다.",
   TechResourceTransportPreference:
      "운송 우선순위 잠금 해제 - 건물이 필요한 자원을 운송하는 우선순위 설정을 할 수 있습니다.",
   ...
   TempleOfArtemisDesc:
      "완성시 모든 검 대장간과 무기고가 +5레벨을 얻습니다. 모든 검 대장간과 무기고가 +1의 생산, 저장소, 작업자 용량 배수를 얻습니다.",
   TempleOfHeaven: "천단",
